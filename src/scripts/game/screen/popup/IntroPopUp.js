...
export default class IntroPopUp extends StandardPop {
    constructor(label, screenManager) {
        ...
        this.continueButton = new UIButton(this.w * 0.3, this.w * 0.3 * 0.25, "LET'S GO") //PIXI.Sprite.from('back_button.png');
        ...
        this.popUpLabel = new PIXI.Text(LOCALIZATION.START_SCREEN_TITLE[LANGUAGE],
            {
                fontFamily: 'lilita_oneregular',
                fontSize: '24px',
                fill: 0x3c7fb4,
