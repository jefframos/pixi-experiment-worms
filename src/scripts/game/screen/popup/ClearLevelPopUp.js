...
export default class ClearLevelPopUp extends StandardPop {
    constructor(label, screenManager) {
        ...
        this.infoContainer.addChild(this.infoList);
         ...
         this.popUpLabel = new PIXI.Text(LOCALIZATION.LEVEL_CLEAR_TITLE[LANGUAGE],
        {
            fontFamily: 'lilita_oneregular',
            fontSize: '24px',
            fill: 0x3c7fb4,
    ...
    show(params) {
        ...
        if (params) {
            ...
            switch (params.level) {
                case 0:
                    {
                        this.titleLabel.text = LOCALIZATION.LEVEL_1_END[LANGUAGE]
                        break
                    }
                case 1:
                    {
                        this.titleLabel.text = LOCALIZATION.LEVEL_2_END[LANGUAGE]
                        break
                    }
                case 2:
                    {
                        this.popUpLabel.text = LOCALIZATION.GAME_CLEAR_TITLE[LANGUAGE]
                        this.titleLabel.text = LOCALIZATION.LEVEL_3_END[LANGUAGE]
                        break
                    }
            }
        }
